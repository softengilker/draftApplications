...
<p>Örnek uygulamada, yaratılacak nesne <font class="icerikKodVurgu">Pide</font> nesnesidir. Pide sınıfının kurucusu, <font class="icerikKodVurgu">PideKurucusu</font> ismindeki sınıftır. Pide kurucusu, Lahmacun ve KuşbaşılıPide şeklinde iki çeşittir. İstemci nesne yani Aşçı, Pide sınıfının yaratılma sorumluluğunu PideKurucu kurucu sınıfına bırakmıştır. Pide kurucusu, "malzemeKur", "hamurKur" ve "baharatKur" yordamları ile nesnenin kademe kademe kurulumuna ve yeni özellikler kazanmasına imkan kılar. Örnekte <font class="icerikKodVurgu">PideSalonu</font> nesnesi, kurucusunu "LahmacunPideKurucu" olarak seçer ve bunu Aşçı sınıfına geçer. Aşçı kademe kademe nesneyi ( Pide ) yi oluşturur ve istemciye geri döner.</p>
